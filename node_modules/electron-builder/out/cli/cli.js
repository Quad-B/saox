...
function rebuildAppNativeCode(_x) {
  return _rebuildAppNativeCode.apply(this, arguments);
} function _rebuildAppNativeCode() {
  _rebuildAppNativeCode = (0, _bluebirdLst().coroutine)(function* (args) {
