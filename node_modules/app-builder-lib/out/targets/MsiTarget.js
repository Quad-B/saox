...
const projectTemplate = new (_lazyVal().Lazy)(
/*#__PURE__*/
...
class MsiTarget extends _core().Target {
  ...
  build(appOutDir, arch) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      const artifactName = packager.expandArtifactBeautyNamePattern(_this.options, "msi", arch);
      ...
      const vendorPath = yield (0, _binDownload().getBinFromUrl)("wix", "4.0.0.5512.2", "/X5poahdCc3199Vt6AP7gluTlT1nxi9cbbHhZhCMEu+ngyP1LiBMn+oZX7QAZVaKeBMc2SjVp7fJqNLqsUnPNQ=="); // noinspection SpellCheckingInspection
