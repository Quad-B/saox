import React, { createContext, useState, useEffect, createRef, useRef, useCallback, useLayoutEffect, useContext, Fragment as Fragment$1, useReducer } from 'react';
...
var MinimizeIcon = function (_a) {
    var isWin = _a.isWin;
    return isWin ? (React.createElement("svg", { version: "1.1", "aria-hidden": "true", width: "10", height: "10" },
        React.createElement("path", { d: "M 0,5 10,5 10,6 0,6 Z" })))
        : (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16" },
...
var MaximizeIcon = function (_a) {
    var isWin = _a.isWin;
    return isWin ? (React.createElement("svg", { version: "1.1", "aria-hidden": "true", width: "10", height: "10" },
        React.createElement("path", { d: "M 0,0 0,10 10,10 10,0 Z M 1,1 9,1 9,9 1,9 Z" })))
        : (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16" },
...
var CloseIcon = function (_a) {
    var isWin = _a.isWin;
    return isWin ? (React.createElement("svg", { "aria-hidden": "true", version: "1.1", width: "10", height: "10" },
...
var useTheme = function (overrides, platform) {
    if (platform === void 0) { platform = 'win32'; }
    var _a = useState(mergeTheme(overrides, platform)), currentTheme = _a[0], setTheme = _a[1];
    useEffect(function () {
        setTheme(mergeTheme(overrides, platform));
    }, [overrides, platform]);
    return currentTheme;
};
var ThemeContext = createContext(mergeTheme());
...
var useChildRefs = function (children) {
    var _a = useState(createRefs(children)), refs = _a[0], setRefs = _a[1];
    useEffect(function () {
...
var useMenu = function (platform, menu) {
    var _a = useState(buildMenu(__spreadArrays((menu !== null && menu !== void 0 ? menu : [])), platform)), currentMenu = _a[0], setMenu = _a[1];
    useEffect(function () {
...
var useWindowFocus = function () {
    var _a = useState(document.hasFocus()), focused = _a[0], setFocused = _a[1];
    useEffect(function () {
...
var calcMenuOverflow = function (menu, menuBar, refs, overflowRef) {
    ...
    var activeMenus = useRef((_a = menu === null || menu === void 0 ? void 0 : menu.length) !== null && _a !== void 0 ? _a : 0);
...
var WindowButton = function (_a) {
    ...
    return (React.createElement("div", { ref: ref, className: styles.Control },
...
var buttons = function (isWin, onMinimize, onMaximize, onClose) { return ([
    {
        type: 'minimize',
        onClick: onMinimize,
        icon: React.createElement(MinimizeIcon, { isWin: isWin })
    },
    {
        type: 'maximize',
        onClick: onMaximize,
        icon: React.createElement(MaximizeIcon, { isWin: isWin })
    },
    {
        type: 'close',
        onClick: onClose,
        icon: React.createElement(CloseIcon, { isWin: isWin })
    }
]); };
var WindowControls = function (_a) {
    ...
    var _b = useContext(ThemeContext), platform = _b.platform, bar = _b.bar, controls = _b.controls;
    var isWin = platform === 'win32';
    var width = platform === 'win32' ? '146px' : '120px';
    return (React.createElement("div", { className: styles.ControlsWrapper, style: {
            opacity: focused ? 1 : bar.inActiveOpacity,
            width: width
        } }, buttons(isWin, onMinimize, onMaximize, onClose).map(function (b) {
        return (React.createElement(WindowButton, { key: b.type, platform: platform, close: b.type === 'close', onClick: b.onClick, controls: controls }, b.icon));
    })));
};
...
var Checked = (React.createElement("svg", { width: "1792", height: "1792", viewBox: "0 0 1792 1792", xmlns: "http://www.w3.org/2000/svg" },
...
var RadioUnchecked = (React.createElement("svg", { width: "1792", height: "1792", viewBox: "0 0 1792 1792", xmlns: "http://www.w3.org/2000/svg" },
...
var RadioChecked = (React.createElement("svg", { width: "1792", height: "1792", viewBox: "0 0 1792 1792", xmlns: "http://www.w3.org/2000/svg" },
...
var Arrow = (React.createElement("svg", { version: "1.1", width: "24px", height: "24px" },
    React.createElement("g", { id: "Rounded" },
...
var MenuIcon = function () { return (React.createElement("svg", { version: "1.1", width: "24px", height: "24px", viewBox: "0 0 32 32" },
    ...
    switch (item.type) {
        ...
        default: {
            if (item === null || item === void 0 ? void 0 : item.icon) {
                return (React.createElement("div", { className: styles.MenuItemIcon, style: { backgroundImage: "url(" + item.icon + ")" } }));
            }
...
var MenuItemComponent = function (_a) {
    ...
    if (isItemSeparator(item)) {
        return (React.createElement("hr", { className: styles.Separator, style: { borderBottom: "1px solid " + theme.menu.separator.color } }));
    }
    ...
    return (React.createElement("li", { className: styles.MenuItemContainer, ref: ref, style: {
            color: textColor,
            opacity: !item.disabled ? 1 : 0.3,
            backgroundColor: backgroundColor
        }, role: "option", onClick: onClick },
        React.createElement("a", { className: styles.MenuItemWrapper, style: {
            ...
            React.createElement("div", { className: styles.StatusIcon, style: { color: iconColor } }, getStatusIcon(item)),
            React.createElement("span", { className: styles.MenuItemLabel }, item.label),
            React.createElement("span", { className: styles.Accelerator, style: { color: acceleratedColor } }, item.accelerator),
            isSubMenu && React.createElement("div", { className: styles.SubMenuArrow }, Arrow)),
        !item.disabled && isSubMenu && selectedSub && (React.createElement(MenuList$1, { key: depth, menu: (_d = item.submenu) !== null && _d !== void 0 ? _d : [], ref: ref, currentWindow: currentWindow, depth: depth + 1, selectedPath: selectedPath, dispatch: dispatch, subLabel: item.label }))));
};
...
var MenuList = function (_a) {
    ...
    return (React.createElement("div", { className: styles.MenuListContainer, style: {
        ...
        hasSubLabel &&
            React.createElement("div", { className: styles.SubMenuLabel, style: {
                    color: (_b = theme.menu.header) === null || _b === void 0 ? void 0 : _b.color
                } }, subLabel),
        React.createElement("div", { className: styles.MenuListScrollView },
            React.createElement("div", { className: styles.MenuList, style: {
                    maxHeight: maxHeight,
                    maxWidth: maxWidth
                }, onWheel: handleScroll, ref: scrollRef },
                React.createElement("div", { className: styles.MenuListVertical, style: {
                        padding: hasSubLabel ? '0px 0px 5px 0px' : '5px 0px'
                    } },
                    React.createElement("ul", { className: styles.MenuListItems }, menu &&
                        menu.map(function (item, idx) { return (React.createElement(MenuItemComponent, { key: item.label + "-" + depth + "-" + idx, idx: idx, item: item, currentWindow: currentWindow, depth: depth, selectedPath: selectedPath, dispatch: dispatch, onClick: function (e) {
                                return menuItemClick(e, idx, item, menu, dispatch, currentWindow);
                            } })); })))))));
};
// export default MenuList;
var MenuList$1 = React.forwardRef(function (props, ref) { return (
// eslint-disable-next-line react/jsx-props-no-spreading
React.createElement(MenuList, __assign({}, props, { parentRef: ref }))); });

var Overlay = function (_a) {
    var top = _a.top, onClick = _a.onClick;
    var theme = useContext(ThemeContext);
    var click = useCallback(function (e) {
        onClick && onClick(e);
    }, [onClick]);
    return (React.createElement("div", { className: styles.MenuOverlay, style: {
...
var Button = function (_a) {
    ...
    myRef = myRef !== null && myRef !== void 0 ? myRef : useRef(null);
    ...
    return (React.createElement("div", { className: styles.MenuButtonContainer, ref: myRef, style: __assign(__assign({}, (style !== null && style !== void 0 ? style : {})), { backgroundColor: backgroundColor }), tabIndex: 0, "aria-haspopup": true },
        open && !hideOverlay && (React.createElement(Overlay, { top: bounds.bottom })),
        open && children,
        React.createElement("div", { className: styles.MenuButtonWrapper },
            React.createElement("button", { className: styles.MenuButton, ref: hoverRef, style: {
                    color: color,
                    maxWidth: theme.maxWidth
                }, onClick: onClick },
                React.createElement("div", { className: styles.MenuButtonLabelWrapper, style: { opacity: opacity, maxWidth: theme.maxWidth } }, label)))));
};
var Button$1 = React.forwardRef(function (props, ref) {
    return React.createElement(Button, __assign({}, props, { myRef: ref }));
});
...
var MenuButton = function (_a) {
    ...
    var onHover = useCallback(function (hovering) {
    ...
    return (React.createElement(Button$1, { ref: myRef, disabled: (_c = item.disabled) !== null && _c !== void 0 ? _c : false, open: open, theme: __assign({}, theme.bar.button), focused: focused, style: style, inactiveOpacity: theme.bar.inActiveOpacity, onClick: onClick, label: icon !== null && icon !== void 0 ? icon : (React.createElement(Fragment$1, null,
            React.createElement("span", { className: styles.MenuButtonLabel, style: {
                    textDecoration: textDecoration
                }, "aria-hidden": "true", tabIndex: -1 }, label.first),
            React.createElement("span", { className: styles.MenuButtonLabel, "aria-hidden": "true", tabIndex: -1 }, label.rest))), onOverlayClick: onClose, onHover: onHover },
        React.createElement(MenuList$1, { key: depth, menu: (_d = item.submenu) !== null && _d !== void 0 ? _d : [], ref: myRef, currentWindow: currentWindow, depth: depth + 1, selectedPath: selectedPath, dispatch: dispatch })));
};
var MenuButton$1 = React.forwardRef(function (props, ref) {
    return React.createElement(MenuButton, __assign({}, props, { myRef: ref }));
});
...
var HorizontalMenu = function (_a) {
    ...
    var _b = useState(immutableSplice(menu, overflow.index, 0, overflowItem(overflow.menu))), fixedMenu = _b[0], updateFixedMenu = _b[1];
    var width = useWidth();
    var prevWidth = usePrevious(width);
    var _c = useReducer(menuReducer, initialState), _d = _c[0], selectedPath = _d.selectedPath, altKey = _d.altKey, dispatch = _c[1];
    useEffect(function () {
    ...
    return (React.createElement(Fragment$1, null, fixedMenu.map(function (menuItem, i) {
        ...
        return (React.createElement(MenuButton$1
...
var VerticalMenu = function (_a) {
    ...
    var _b, _c;
    var _d = useState([menuButton(menu)]), fixedMenu = _d[0], updateFixedMenu = _d[1];
    var childRefs = useChildRefs(fixedMenu);
    var width = useWidth();
    var prevWidth = usePrevious(width);
    var _e = useReducer(menuReducer, initialState), selectedPath = _e[0].selectedPath, dispatch = _e[1];
    useEffect(function () {
        // close menu when focused away from window
        // close menu when resizing the window
    ...
    return (React.createElement(MenuButton$1, { ref: childRefs[0], focused: focused, idx: 0, item: fixedMenu[0], currentWindow: currentWindow, depth: depth$2, selectedPath: selectedPath, dispatch: dispatch, icon: React.createElement(MenuIcon, null), altKey: false }));
};

var MenuBar = function (_a) {
    var menu = _a.menu, focused = _a.focused, currentWindow = _a.currentWindow;
    var _b = useContext(ThemeContext), platform = _b.platform, style = _b.menu.style;
    var menuBar = useRef(null);
    var currentMenu = useMenu(platform, menu);
    return (React.createElement("div", { className: styles.MenuBar, role: "menubar", ref: menuBar }, style === 'vertical' ? (React.createElement(VerticalMenu, { menu: currentMenu, focused: focused, currentWindow: currentWindow }))
        : (React.createElement(HorizontalMenu, { menu: currentMenu, menuBar: menuBar, focused: focused, currentWindow: currentWindow }))));
};
...
var Title = function (_a) {
    ...
    var _b = useContext(ThemeContext), _c = _b.bar, height = _c.height, title = _c.title, inActiveOpacity = _c.inActiveOpacity, style = _b.menu.style;
    ...
    return (React.createElement("div", { className: styles.Title, style: {
...
var Bar = function (_a) {
    ...
    var _b = useContext(ThemeContext), platform = _b.platform, _c = _b.bar, height = _c.height, borderBottom = _c.borderBottom, background = _c.background, fontFamily = _c.fontFamily, color = _c.color, style = _b.menu.style;
    var ref = useRef(null);
    var dblClick = useCallback(function (e) {
        if (e.target == ref.current) {
            onDoubleClick && onDoubleClick(e);
        }
    }, [ref.current, onDoubleClick]);
    var isDarwin = platform === 'darwin';
    return (React.createElement("div", { className: styles.Bar, ref: ref, style: {
...
var Logo = function (_a) {
    ...
    if (src && src !== '') {
        return (React.createElement("img", { className: className, src: src, style: style }));
    }
...
var TitleBar = function (_a) {
    ...
    return (React.createElement(ThemeContext.Provider, { value: currentTheme },
        React.createElement(Fragment$1, null,
            React.createElement(Bar, { onDoubleClick: onDoubleClick },
                React.createElement("div", { className: classnames(styles.ResizeHandle, styles.Top) }),
                React.createElement("div", { className: classnames(styles.ResizeHandle, styles.Left), style: { height: (_f = theme === null || theme === void 0 ? void 0 : theme.bar) === null || _f === void 0 ? void 0 : _f.height } }),
                !isDarwin && !controlsRight && (React.createElement(WindowControls, { focused: focused, disableMaximize: disableMaximize, disableMinimize: disableMinimize, onMinimize: onMinimize, onMaximize: onMaximize, onClose: onClose })),
                !vertical && hasIcon && React.createElement(Logo, { src: iconSrc, hasTitle: hasTitle }, icon),
                !isDarwin && !stacked && hasMenu && (React.createElement(MenuBar, { focused: focused, menu: menu, currentWindow: currentWindow })),
                vertical && hasIcon && React.createElement(Logo, { src: iconSrc, hasTitle: hasTitle }, icon),
                React.createElement(Title, { focused: focused, hasIcon: hasIcon, hasMenu: hasMenu }, title),
                children,
                !isDarwin && controlsRight && (React.createElement(WindowControls, { focused: focused, disableMaximize: disableMaximize, disableMinimize: disableMinimize, onMinimize: onMinimize, onMaximize: onMaximize, onClose: onClose }))),
            !isDarwin && stacked && (React.createElement(Bar, { bottomBar: true }, hasMenu &&
                React.createElement(MenuBar, { focused: focused, menu: menu, currentWindow: currentWindow }))))));
};

export default TitleBar;
export { Overlay as MenuOverlay, Button$1 as TitleBarButton, ThemeContext as TitleBarThemeContext };
